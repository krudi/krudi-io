...
- Content fetched via GraphQL (Apollo Client) — co-locate queries with the components that use them
- No database — purely SSG/ISR where possible; avoid adding server-side state
